		...
		<?php require_once('includes/top_menu.php') ?>	<hr/>
				...
				<table style='width:100%'>
					...
					// Connect to the database 
						...
						echo'<tr>';
							echo '<td>number of users in the App:</td>'.'<td>'.$data['total'].'</td>';
						echo'</tr>';
						...
						$data=mysql_fetch_assoc($result);			
						echo'<tr>';
							echo '<td>number of posts in the App:</td>'.'<td>'.$data['total'].'</td>';
						echo'</tr>';
						...
						$data=mysql_fetch_assoc($result);
						echo'<tr>';
							echo '<td>number of university in the App:</td>'.'<td>'.$data['total'].'</td>';
						echo'</tr>';
						...
						$data=mysql_fetch_assoc($result);
						echo'<tr>';
							echo '<td> number of comments in the App:</td>'.'<td>'.$data['total'].'</td>';
						echo'</tr>';
						//counting the number of the categories
						$result=mysql_query("SELECT count(*) as total from categories");
						$data=mysql_fetch_assoc($result);
						echo'<tr>';
							echo '<td> number of categories in the App:</td>'.'<td>'.$data['total'].'</td>';
						echo'</tr>';
					?>
				</table>
