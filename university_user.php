		...
		<div class="form-group">
			<div  class="col-xs-10" >
				<table style='width:100%'>
					<tbody>
						<tr>
							<td><b>&nbsp&nbsp&nbsp&nbsp User ID</b></td>			
							<td><b>&nbsp&nbsp&nbsp&nbsp Username</b></td>
				...
				<?php
				    ...
				    // Connect to the database 
				        ...
				        $query = "SELECT * FROM users WHERE uni_id = '$uni_id' ";
				...
				// Display the score data
							...
							echo "<table style='width:100%; text-align:left;'>";
									echo"<tr>";
										echo '<td><a href="#.php?user_id='.$row['user_id'].'">&nbsp&nbsp&nbsp&nbsp' . $row['user_id'] .'</a></td>';
